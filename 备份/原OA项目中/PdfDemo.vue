...
-->
                ...
                <div class="key-info-line">
                    <div class="info-row">
                        ...
                        <span>山东省青岛市崂山区中国农业银行(崂山区香港中路支行)山东省青岛市崂山区中国农业银行</span>
                ...
                <footer style="display: flex">
                    <div style="flex: 1;">
                        <div>甲方（转让方）：</div>
                        <div style="position: relative; padding-top: 50px">XXXXXXXXXXXXXXX基金管理有限公司<img src="/static/sealPic/seal_js.png" alt="章" style="position: absolute; top: -50px; left: 0; width: 190px; height: 190px;"/></div>
                    </div>
                    <div style="flex: 1; margin-left: 30px;">
                        <div>乙方（投顾方）：</div>
                        <div style="position: relative; padding-top: 50px">XXXXXXXXXXXXXXX信息服务有限公司<img src="/static/sealPic/seal_jr.png" alt="章" style="position: absolute; top: -50px; left: 0; width: 190px; height: 190px;"/></div>
                    </div>
                ...
                <!--印章-->
<!--                <div class="seal_hz" style="position: absolute; bottom: 50px; left: 100px; width: 200px; height: 200px; background-image: url('/static/sealPic/seal_js.png'); background-position: 50% 50%; background-size: 200px 200px; background-repeat: no-repeat"></div>-->
<!--                <div class="seal_hz" style="position: absolute; bottom: 0px; left: 100px; width: 200px; height: 200px;"><img src="/static/sealPic/seal_js.png" alt="章" style="width: 200px;"/></div>-->

<!--                <div class="seal_hz" style="position: absolute; bottom: 0px; left: 350px; width: 200px; height: 200px;"><img src="/static/sealPic/seal_jr.png" alt="章" style="width: 200px;"/></div>-->

<!--                <div class="seal_jr" style="position: absolute; bottom: 0; left: 300px; width: 200px; height: 200px; background-image: url('/static/sealPic/seal_jr.png'); background-position: 50% 50%; background-size: 270px 270px; background-repeat: no-repeat"></div>-->
